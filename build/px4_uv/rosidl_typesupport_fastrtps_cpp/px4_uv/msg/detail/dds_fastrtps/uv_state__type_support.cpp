...
#include "px4_uv/msg/detail/uv_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_uv::msg::UvState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_uv::msg::UvState & ros_message)
{
  // Member: pos
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_uv::msg::UvState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_uv::msg::UvState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_uv::msg::UvState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UvState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_uv::msg::UvState *>(
...
static size_t _UvState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UvState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UvState__callbacks = {
  "px4_uv::msg",
  "UvState",
...
static rosidl_message_type_support_t _UvState__handle = {
...
{
  return &px4_uv::msg::typesupport_fastrtps_cpp::_UvState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_uv, msg, UvState)() {
  return &px4_uv::msg::typesupport_fastrtps_cpp::_UvState__handle;
}
