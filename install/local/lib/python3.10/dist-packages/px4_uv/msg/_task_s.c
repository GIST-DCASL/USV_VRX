...
bool px4_uv__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_uv.msg._task.Task", full_classname_dest, 21) == 0);
  }
  px4_uv__msg__Task * ros_message = _ros_message;
  {  // task_id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_uv__msg__task__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Task */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_uv.msg._task");
  ...
  px4_uv__msg__Task * ros_message = (px4_uv__msg__Task *)raw_ros_message;
  {  // task_id
    PyObject * field = NULL;
